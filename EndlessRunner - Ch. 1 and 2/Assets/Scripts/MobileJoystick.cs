...
public class MobileJoystick : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    /// <summary>
    /// Gets the value of the joystick in a -1 to 1 manner in the same way that Input.GetAxis does
    /// </summary>
    ...
    /// </summary>
    /// <param name="eventData">Information about the movement, we are only using the position</param>
    ...
    /// </summary>
    /// <param name="eventData">Information about the movement, unused</param>
